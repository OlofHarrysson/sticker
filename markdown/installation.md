...
4. In step 2 "Grant this service account access to project", set the role to **Project Owner** and press <kbd>Continue</kbd>.  In step 3 "Grant users access to this service account", press <kbd>Create key</kbd> to download the json-file that contains the key. Don't share this key-file as anyone who gets a hold of it can access and use your Google Cloud project. Press <kbd>Done</kbd> to complete the service account setup
